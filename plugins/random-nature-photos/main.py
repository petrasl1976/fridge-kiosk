...
def get_next_photo(config):
    """Get the next photo in sequence"""
    cache_data = load_cache()
    ...
    logging.info(f"Advanced to photo {next_index + 1}/{len(photos)}")
    
    current_photo = photos[next_index]
